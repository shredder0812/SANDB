  ...
  //var temp = "";
    ...
    obj.san.forEach((r) => 
    {
      ...
      { 
        ...
        var insertLine = `insert into public.object_details (className, closed, cad_id, layer, linetype, linetype_scale, lineweight, material, thickness, transparency, coords) values ('`+ r.className +`','`+r.closed+`','`+r.id+`','`+r.layer+`','`+r.linetype+`','`+r.linetype_scale+`','`+r.lineweight+`','`+r.material+`','`+r.thickness+`','`+r.transparency+`',ST_GeomFromText('linestring(`+ tempL +`)'))`               
        module.exports = {
          insertLine
        }
        //console.log(`insert into public.demo (name, geometric_filed) values('line',ST_GeomFromText('linestring(`+ tempL +`)'))`);
      }
      ...
      { 
        ...
        var insertCircle = `insert into public.object_details (className, closed, cad_id, layer, linetype, linetype_scale, lineweight, material, thickness, transparency, coords) values ('`+ tempC1+`, `+ r.coordscenter.x +` `+tempC2+`, `+tempC3+`, `+ r.coordscenter.x +` `+tempC4+`, `+tempC1 +`)'))`  
        module.exports = {
          insertCircle
        }
        ...
        //console.log(tempC1+`, `+ r.coordscenter.x +` `+tempC2+`, `+tempC3+`, `+ r.coordscenter.x +` `+tempC4+`, `+tempC1)
